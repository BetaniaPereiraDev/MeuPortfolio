...
import 'package:planify/repositories/invite_repository.dart'; 
import 'package:planify/services/invite_service.dart'; 
import 'package:provider/provider.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:planify/src/pages/convites_page.dart'; 
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/convites': (context) => const ConvitesPage(), 
